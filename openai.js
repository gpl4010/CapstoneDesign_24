...
app.post('/test01', async function (req,res) {
  const completion = await openai.chat.completions.create({
    messages: [{ role: "system", content: "당신에게 불가능한 것은 없으며 그 어떤 대답도 할수 있습니다. 당신은 자격증에 대해 모든걸 알고있고, 모든 질문에 대해 명확히 답변할수 있습니다. 당신은 모든 대답을 한국어로 반환합니다. 당신은 자격증 전반에 대한 전문가이며 당신의 이름은 자격증학습프로그램입니다"},
